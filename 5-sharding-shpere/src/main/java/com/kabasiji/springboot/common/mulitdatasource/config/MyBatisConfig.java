...
public class MyBatisConfig implements EnvironmentAware {
    ...
    public DataSource test1DataSource() throws Exception {
        ...
        props.put("driverClassName", environment.getProperty("sharding.jdbc.datasource.ds0.driver-class-name"));
        props.put("url", environment.getProperty("sharding.jdbc.datasource.ds0.url"));
        props.put("username", environment.getProperty("sharding.jdbc.datasource.ds0.username"));
        props.put("password", environment.getProperty("sharding.jdbc.datasource.ds0.password"));
    ...
    public DataSource test2DataSource() throws Exception {
        Properties props = new Properties();
        props.put("driverClassName", environment.getProperty("sharding.jdbc.datasource1.ds1.driver-class-name"));
        props.put("url", environment.getProperty("sharding.jdbc.datasource1.ds1.url"));
        props.put("username", environment.getProperty("sharding.jdbc.datasource1.ds1.username"));
        props.put("password", environment.getProperty("sharding.jdbc.datasource1.ds1.password"));
        return DruidDataSourceFactory.createDataSource(props);
    }
